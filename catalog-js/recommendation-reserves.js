...
if (location.href.match('cgi-bin/koha/opac-suggestions.pl\\?op=add')) {
    ...
    let p2 = 'We prioritize titles used in the curriculum and may need to limit the number of requests accepted due to budget constraints. You will receive an email when we determine whether to acquire your suggestion. If this purchase recommendation is meant for course reserves, remember to <a href="https://docs.google.com/forms/d/e/1FAIpQLScq7SDjDi6bzu7OcHdI-4ec3CdKvmWLpcv8oxdwr7IksUYiKw/viewform?usp=sf_link">fill out the Course Reserves Request</a> form, too.'
